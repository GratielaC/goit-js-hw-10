...
parcelHelpers.export(exports, "countryList", ()=>countryList);
parcelHelpers.export(exports, "countryInfo", ()=>countryInfo);
...
var _inputEventHandlerJs = require("./jsFiles/inputEventHandler.js");
var _inputEventHandlerJsDefault = parcelHelpers.interopDefault(_inputEventHandlerJs);
const DEBOUNCE_DELAY = 300;
const searchInput = (0, _getElementJs.getElement)('#search-box');
const countryList = (0, _getElementJs.getElement)('.country-list');
const countryInfo = (0, _getElementJs.getElement)('.country-info');
searchInput.addEventListener('input', (0, _lodashDefault.default).debounce((0, _inputEventHandlerJsDefault.default), DEBOUNCE_DELAY));

},{"./css/styles.css":"1CY4s","./jsFiles/getElement.js":"eRbd9","lodash":"3qBDj","./jsFiles/inputEventHandler.js":"kQCQE","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"1CY4s":[function() {},{}],"3qBDj":[function(require,module,exports,__globalThis) {
var global = arguments[3];
(function() {
...
},{}],"kQCQE":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const inputEventHandler = ()=>{
    searchName = (0, _indexJs.searchInput).value;
    searchName = searchName.trim();
    if (searchName === '') {
        clearDisplay();
        return (0, _notiflixDefault.default).Notify.info('please type a country name');
    } else {
        const url = `https://restcountries.com/v3.1/name/${searchName}?fields=name,capital,population,flags,languages`;
        fetchCountries(url);
    }
};
exports.default = inputEventHandler;

},{"../index.js":"8lqZg","notiflix":"fuMq1","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9mu7C","8lqZg"], "8lqZg", "parcelRequire94c2")
